...
const Searchbar = () => {
  return (
    <div className="mx-auto mt-5 w-screen max-w-screen-md py-5 leading-6"> 
  <form className="relative mx-auto flex w-full max-w-2xl items-center justify-between rounded-md border shadow-lg"> 
    ...
    <input type="name" name="search" className="h-14 w-full rounded-md py-4 pr-40 pl-12 outline-none focus:ring-2" placeholder="Enter Song" />
