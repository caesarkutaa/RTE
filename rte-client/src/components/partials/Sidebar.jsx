...
const Sidebar = () => {
  return (
    <div>
        ...
        <span className="text-xl">Right Time Entertainment</span>
        </span>
    ...
    <div className="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
      <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
        ...
        <li className="md:mr-12"><a href="#">Music Videos</a></li>
        <li className="md:mr-12"><a href="#">News</a></li>
        <li className="md:mr-12">
          <button class="rounded-full border-2 border-cyan-500 px-6 py-1 text-cyan-600 transition-colors hover:bg-cyan-500 hover:text-white">Contact us</button>
        </li>
      </ul>
    </div>
  </div>
